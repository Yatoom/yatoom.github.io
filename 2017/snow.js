var game = new Phaser.Game(window.innerWidth, window.innerHeight, Phaser.AUTO, 'phaser', { preload: preload, create: create });
...
function create() {
    ...
    var style = { font: "75px Roboto Slab", fill: "#fff", align: "center" };
    var name = window.location.hash.slice(1)
    var sentence = "Gelukkig 2017!"

    if (name != "") {
      sentence = [name, "gelukkig 2017!"].join(", ")
    }

    var text = game.add.text(game.world.centerX, game.world.centerY - 50, sentence, style);
    text.stroke = '#000000';
